...
- support analyzer 是轻量扫描器，不替代完整 parser；v1 只覆盖当前 support matrix 声明的 unsupported diagram family 和常见 flowchart syntax，包括当前按 literal text 降级的 entity-code / FontAwesome label。
