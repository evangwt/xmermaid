...
pub fn layout(board: &KanbanAst, config: &LayoutConfig) -> LayoutResult {
    ...
    LayoutResult {
        ...
        kanban_board: Some(KanbanBoardLayout { columns }), treemap: None, radar: None, packet: None, venn: None, swimlanes: None, sequence: None, ishikawa: None, wardley: None, cynefin: None,
    }
}
