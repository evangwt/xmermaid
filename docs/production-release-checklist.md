...
- Node/SSR parsing of the root ESM entry is a package compatibility check, not a Node rendering promise.
...
- README documents diagnostics and security strict defaults.
- README documents packed consumer smoke and Chrome/`CHROME_BIN`.
...
- Confirm package size and browser render duration from consumer smoke are recorded in the JSON summary.
